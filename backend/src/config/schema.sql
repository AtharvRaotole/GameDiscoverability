...
-- Note: No vector index needed - we use Pinecone for vector search (3072 dims > Supabase's 2000 limit)
-- The emotion_vector column is stored but not indexed in PostgreSQL
